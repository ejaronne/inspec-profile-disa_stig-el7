BANNER_MESSAGE_TEXT = attribute('banner_message_text', default: 'TODO!!!',
description: 'The banner message  must display the Standard Mandatory DoD 
Notice and Consent Banner before granting access.')
...
and work product are private and confidential. See User Agreement for details.\""
  ...
  describe file("/etc/issue") do
    its('content') { should cmp BANNER_MESSAGE_TEXT }
  end
